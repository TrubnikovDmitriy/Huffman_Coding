...
// 2) С помощью ридера считываем заголовочную информацию и формируем дерево, получаем кол-во символов
...
void Decode::decode(string decompressed_name) {
    ...
    while(!br->eof() && count_symbols < symbols) {
